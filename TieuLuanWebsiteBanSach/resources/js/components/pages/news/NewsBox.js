                        ...
                        <div class="col-xl-6 col-md-12 col-12">
                            <div class="itemBigNew">
                                ...
                                <p>Một trong những nhà văn rất thành công của văn học Việt Nam, những tác phẩm của ông
                                    luôn để lại những cảm xúc rất lớn trong lòng người đọc.</p>
                            </div>
                            <ul>
                                <li><a href="#">Triển lãm sách lớn nhất năm tại TP Hồ Chí Minh.</a></li>
                                <li><a href="#">Hội thảo về các phương pháp đọc sách hay.</a></li>
                                <li><a href="#">"Cánh diều mơ ước" cuộc thi cho tác giả trẻ.</a></li>
                            </ul>
                        </div>
                        <div class="col-xl-3 col-md-12 col-12">
                            <div class="row">
